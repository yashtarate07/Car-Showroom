...
const Login = () => {
    ...
    return (
        <div id="container">
            ...
            <h2 style={{position:'relative',left:'-30%'}}>Login</h2>
           <form  onSubmit={handleSubmit}>
           <label style={{ display: 'block', marginBottom: '10px' }}>Email:</label>
            <input type="email"placeholder=" email"id="email" name="email" value={email} onChange={(e)=>{setEmail(e.target.value)}}  required style={{ width: '96%', padding: '8px', marginBottom: '20px' }}
          />
...
<br />
        ...
        <p style={{color:'black'}}>Dont have Account <Link style={{color:'rgb(206,14,14)'}} to="/signup">Signup</Link></p>
      </div>
      <ToastContainer />
        </div>
    );
